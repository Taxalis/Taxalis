      ...
      <main style={{ fontFamily: "'Inter', sans-serif", background: "#ffffff", color: "#111827" }}>
        <style>{`
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .benefit-card:hover { background: #f3f4f6; border-color: #d1d5db; transform: translateY(-2px); }
          ...
          .feature-item { background: #f9fafb; padding: 20px; border-radius: 8px; border-left: 3px solid #1f2937; }
          ...
          .step-number { background: #1f2937; color: white; width: 50px; height: 50px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 20px; flex-shrink: 0; }
          ...
          .cta-box { background: #1f2937; color: white; padding: 80px 24px; text-align: center; }
          .cta-box h2 { font-size: 40px; font-weight: 600; margin-bottom: 16px; }
          .cta-box p { font-size: 18px; margin-bottom: 40px; opacity: 0.9; }
          .btn { background: white; color: #1f2937; padding: 14px 32px; border-radius: 8px; font-size: 14px; font-weight: 600; text-decoration: none; display: inline-block; transition: all 0.3s; border: none; cursor: pointer; }
